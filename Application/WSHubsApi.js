...
function HubsAPI(url, serverTimeout) {
    ...
    this.LoggingHub.server = {
        ...
        loggin : function (user, password){
            
            return constructMessage('LoggingHub', 'loggin', arguments);
        },
        ...
        getMyHouses : function (){
            ...
            return constructMessage('LoggingHub', 'getMyHouses', arguments);
        }
    };
    ...
    this.HouseHub.server = {
        ...
        get_sensor_value : function (sensorId){
            
            return constructMessage('HouseHub', 'get_sensor_value', arguments);
        },
        ...
        set_sensor_value : function (sensorId){
            
            return constructMessage('HouseHub', 'set_sensor_value', arguments);
        }
    };
